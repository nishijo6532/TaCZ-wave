...
public class GunMod {
    ...
    public GunMod() {
        ...
        if (ModListCompat.isLoaded("kubejs")) {
            bus.register(MethodHandles.lookup(), new TimelessKubeJSPlugin());
        }
    ...
    private static void suppressRuntimeDebugInfoLogs() {
        Configurator.setLevel(MOD_ID, Level.WARN);
    }
