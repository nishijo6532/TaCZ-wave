...
public class LocalPlayerDraw {
    ...
    public void draw(ItemStack lastItem) {
        ...
        ForgeEventCompat.post(new GunDrawEvent(player, lastItem, currentItem, LogicalSide.CLIENT));
    ...
    private void doPutAway(ItemStack lastItem, long putAwayTime) {
        if (ClientRenderCompat.getCustomRenderer(lastItem) instanceof AnimateGeoItemRenderer<?, ?> renderer) {
