...
public class FireSelectKey {
    public static final KeyMapping FIRE_SELECT_KEY = KeyMappingCompat.create("key.tacz.fire_select.desc",
    ...
    public static void onFireSelectKeyPress(InputEvent.Key event) {
        if (isInGame() && event.getAction() == GLFW.GLFW_PRESS && KeyMappingCompat.matches(FIRE_SELECT_KEY, event)) {
            doFireSelectLogic();
        }
    }
    ...
    public static void onFireSelectMousePress(InputEvent.MouseButton.Post event) {
        if (isInGame() && event.getAction() == GLFW.GLFW_PRESS && KeyMappingCompat.matchesMouse(FIRE_SELECT_KEY, event)) {
            doFireSelectLogic();
        }
    }
