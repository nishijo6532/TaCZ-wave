...
public class InteractKeyConfigRead {
    ...
    private static final TagKey<Block> WHITELIST_BLOCKS = BlockTags.create(com.tacz.guns.util.IdHelper.id(GunMod.MOD_ID, "interact_key/whitelist"));
    private static final TagKey<Block> BLACKLIST_BLOCKS = BlockTags.create(com.tacz.guns.util.IdHelper.id(GunMod.MOD_ID, "interact_key/blacklist"));
    private static final TagKey<EntityType<?>> WHITELIST_ENTITIES = TagKey.create(Registries.ENTITY_TYPE, com.tacz.guns.util.IdHelper.id(GunMod.MOD_ID, "interact_key/whitelist"));
    private static final TagKey<EntityType<?>> BLACKLIST_ENTITIES = TagKey.create(Registries.ENTITY_TYPE, com.tacz.guns.util.IdHelper.id(GunMod.MOD_ID, "interact_key/blacklist"));
    ...
    private static void handleConfigData(List<String> configData, EnumMap<Type, List<Identifier>> storeList, Type type) {
        configData.forEach(data -> {
            ...
            Identifier id = com.tacz.guns.util.IdHelper.id(data);
