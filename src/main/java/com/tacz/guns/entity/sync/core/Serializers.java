...
public class Serializers {
    ...
    public static final IDataSerializer<ItemStack> ITEM_STACK = new IDataSerializer<>() {
        ...
        public void write(FriendlyByteBuf buf, ItemStack value) {
            buf.writeNbt(NbtCompat.serializeItemStack(value));
        }

        @Override
        public ItemStack read(FriendlyByteBuf buf) {
            return NbtCompat.deserializeItemStack(buf.readNbt());
        }

        @Override
        public Tag write(ItemStack value) {
            return NbtCompat.serializeItemStack(value);
        }

        @Override
        public ItemStack read(Tag tag) {
            return tag instanceof CompoundTag compound ? NbtCompat.deserializeItemStack(compound) : ItemStack.EMPTY;
        }
    };
